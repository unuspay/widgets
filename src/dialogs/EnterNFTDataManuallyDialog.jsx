      ...
      body={
        <div className="PaddingLeftM PaddingRightM">
          <div>
            {
              ...
              <div>
                <div className="PaddingTopXS TextLeft">
                  <label htmlFor="UnusPayWidgetsEnterNFTTokenAddresses">
                    <div className="FontSizeS Opacity05">Token Mint Addresses</div>
                  </label>
                </div>
                <div className="PaddingTopXS PaddingBottomS TextLeft">
                  <textarea id="UnusPayWidgetsEnterNFTTokenAddresses" name="UnusPayWidgetsEnterNFTTokenAddress" value={ addresses } onChange={ (event)=>setAddresses(event.target.value) } placeholder={ "4LWoVdJWNFQCvDZsf2EP6xD8xAF6S7RhQKkA5gjxJEnn\n979vHrvJ5d4CoCv2Hx5PHN837dsJe9ijhNAQwmY7hpcx" } className="InputField small" rows={4} style={{ resize: "vertical", minHeight: "78px", width: "100%" }} />
            ...
            }
            {
              ...
              <div>
                <div className="PaddingTopXS TextLeft">
                  <label htmlFor="UnusPayWidgetsEnterNFTTokenAddress">
                    <div className="FontSizeS Opacity05">Token Contract Address</div>
                  </label>
                </div>
                <div className="PaddingTopXS PaddingBottomS TextLeft">
                  <input id="UnusPayWidgetsEnterNFTTokenAddress" name="UnusPayWidgetsEnterNFTTokenAddress" value={ address } onChange={ (event)=>setAddress(event.target.value) } placeholder={ "0xb47e3cd837ddf8e4c57f05d70ab865de6e193bbb" } className="InputField small" style={{ width: "100%" }} />
                </div>
              </div>
            }
          </div>
          { idRequired &&
            <div>
              <div className="PaddingTopXS TextLeft">
                <label htmlFor="UnusPayWidgetsEnterNFTTokenId">
                  <span className="FontSizeS Opacity05">Token ID</span>
                </label>
              </div>
              <div className="PaddingTopXS PaddingBottomS TextLeft">
                <input id="UnusPayWidgetsEnterNFTTokenId" name="UnusPayWidgetsEnterNFTTokenId" value={ id } onChange={ (event)=>setId(event.target.value) } placeholder="35347623114821255323888368639026081793120226253597860997754787919489216283624" className="InputField small" />
              </div>
            </div>
          }
          <div>
            <div className="PaddingTopXS TextLeft">
              <label htmlFor="UnusPayWidgetsEnterNFTName">
                <span className="FontSizeS Opacity05">NFT Name</span>
              </label>
            </div>
            <div className="PaddingTopXS PaddingBottomS TextLeft">
              <input id="UnusPayWidgetsEnterNFTName" name="UnusPayWidgetsEnterNFTName" value={ name } onChange={ (event)=>setName(event.target.value) } placeholder={ supported.solana.includes(selection?.blockchain?.name) ? 'SMB' : 'CryptoPunks' } className="InputField small" />
            </div>
          </div>
          <div>
            <div className="PaddingTopXS TextLeft">
              <label htmlFor="UnusPayWidgetsEnterNFTImage">
          ...
          <div>
            <div className="PaddingTopXS TextLeft">
              <label htmlFor="UnusPayWidgetsEnterNFTLink">
                <span className="FontSizeS Opacity05">Link URL</span>
              </label>
            </div>
            <div className="PaddingTopXS PaddingBottomS TextLeft">
              <input id="UnusPayWidgetsEnterNFTLink" name="UnusPayWidgetsEnterNFTLink" value={ link } onChange={ (event)=>setLink(event.target.value) } placeholder={ supported.solana.includes(selection?.blockchain?.name) ? "https://magiceden.io/marketplace/smb_gen3" : "https://opensea.io/collection/cryptopunks" } className="InputField small" />
            </div>
          </div>
        </div>
      }
